import CombinedCssTask from './CombinedCssTask.js';
...
Elixir.extend('sassAndLost', function(src, output, options) {
    new CombinedCssTask('sassAndLost', getPaths(src, output), options);
});
